...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="
        cn(
          /* * Default: `bg-background` — as in DialogContent: a sheet is a raised surface, not the page canvas (`catalyst/context/domain-glossary.md`, Page canvas). */
    ...
    >
      ...
      >
        <X class="size-4" />
        <!-- * Default: `Close` — a hard-coded English name read to every locale. -->
