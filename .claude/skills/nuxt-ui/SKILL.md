...
> Vendored from upstream; provenance and re-sync live in `catalyst/stacks/frontend/nuxt/ui/nuxtui/nuxtui.md`. Where this disagrees with the `catalyst/` documents — component naming, SFC section order, the data layer, validation, i18n — the `catalyst/` documents win.
