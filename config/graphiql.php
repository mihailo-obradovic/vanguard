...
return [
    ...
    */
    ...
    // * Changes: default true -> local only. The package is a dev dependency, so a production
    // * install never registers the route; this is the second lock, for environments that do
    // * install dev dependencies. Set GRAPHIQL_ENABLED to override per environment.
    'enabled' => env('GRAPHIQL_ENABLED', env('APP_ENV') === 'local'),
];
