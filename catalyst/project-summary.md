...
| 011 | Error Page                          | Approved | `variant/shadcn-vue` only: Nuxt's error state as a localized card in an empty layout — status-based title and message, Go home / Refresh, a collapsed technical-details disclosure. | [features/011_error-page.md](features/011_error-page.md)                                               |
