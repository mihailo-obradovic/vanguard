...
- `architecture.md` and protected areas are fixed contracts: exploration and architecture agents propose options _within_ them, never alternatives _to_ them, and review agents receive the feature document as the contract to review against.
