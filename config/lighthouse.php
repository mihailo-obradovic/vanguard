...
return [
    ...
    */
    ...
    'route' => [
         ...
         */
        'middleware' => [
            // * Changes: added. The SPA authenticates with a Sanctum session cookie, so the
            // * endpoint needs the stateful stack (cookies, session, CSRF) the REST API gets
            // * from `statefulApi()` in bootstrap/app.php. It must run first.
    ...
    */
    ...
    // * Changes: null -> ['sanctum']. One endpoint serves fields with different access
    // * requirements, so authentication is attempted here and authorization is decided per
    // * field by the @can* directives against the policies.
    'guards' => ['sanctum'],
    ...
    */
    ...
    'error_handlers' => [
        ...
        // * Changes: added, and last on purpose — it reads the exception classes the handlers
        // * above wrap, and stamps the REST-equivalent status the SPA's error handling keys on.
        RestStatusHandler::class,
    ],
