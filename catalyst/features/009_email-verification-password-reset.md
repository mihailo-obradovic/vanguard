...
- Feature 003 (self-service profile): an email change nulls `email_verified_at` and re-sends this feature's verification mail; the profile page hosts the resend button and the `?verified=1` landing.
