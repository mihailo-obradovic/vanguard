...
describe('the app shell', () => {
  ...
  // ! without a navigation. Logout is a navbar button that never leaves the page, and an expired
  // ! session resets the store from under whatever the user was reading — in both cases
