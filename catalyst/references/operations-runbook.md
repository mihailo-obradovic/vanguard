...
- Infra work that introduces or changes a stateful component updates its runbook section in the same change (Same-Change Rule). The decision record keeps the why and the verification evidence; the commands live here — a record is frozen history, the runbook stays current.
