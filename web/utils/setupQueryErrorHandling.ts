...
// * A query shared by multiple components attaches one watcher per component instance, all observing the same error ref. Track handled error objects so a single failure is only ever handled (toasted/redirected) once.
