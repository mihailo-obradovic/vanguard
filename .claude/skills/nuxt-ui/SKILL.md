...
<!-- Vendored verbatim from nuxt/ui @ 14ac243 (branch v4, 2026-08-19); re-vendor rather than edit in place. Upstream guidance, not this repo's: where it disagrees with the catalyst/ documents — component naming, SFC section order, the data layer, validation, i18n — the catalyst/ documents win. -->
